...
const About = () => {
  ...
  return (
    <>
      <SEO title="About | Shekhar Dixit" description="Welcome to the official Shekhar Dixit about page." />
      <div>
        <header className="bg-black text-white text-center py-12 px-5">
          <motion.img
            src={profile}
            alt="Portrait of Shekhar Dixit"
