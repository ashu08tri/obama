...
const ContactUs = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.postalCode) newErrors.postalCode = 'Pin code is required';
  ...
  return (
    <>
    <SEO title="Contact Us | Shekhar Dixit" description="Welcome to the official Shekhar Dixit contact us page."></SEO>
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-extrabold text-white sm:text-4xl">
            Contact Shekhar Dixit
          </h1>
          <p className="mt-4 text-lg text-slate-50">
            Have a message to share with Shekhar Dixit? Please fill out this form to send a note to him.
          </p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-8 mb-8">
          <div className="mb-6 p-4 bg-blue-50 rounded-md border border-blue-200">
            <p className="text-blue-800">
              If you are requesting a greeting for an event such as a birth, wedding or ceremony please use the greetings request form.
              <br /><br />
              We encourage you to use this form to send a note to Shekhar Dixit instead of sending physical mail.
            </p>
          </div>
        ...
        <div className="text-center text-sm text-slate-50">
          ...
          <p className="mt-2">
            <img
              src={letterhead}
              alt="Official letterhead of Shekhar Dixit"
              className="mx-auto"
            />
          </p>
        </div>
