...
const SchedulingForm = () => {
    ...
    return (
        <>
            <SEO title="Schedule | Shekhar Dixit" description="Welcome to the Official Dixit Foundation schedule page."></SEO>
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-50">
                            Please fill out this form to invite Shekhar Dixit and/or his team to appear or speak at your event.
                        </p>
                    </div>
