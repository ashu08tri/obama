            ...
            <div className="bg-black min-h-screen py-10">
                <div className="max-w-3xl mx-auto p-4">
                    <div className='flex justify-center'>
                        <img src={ks} alt="ks" className='w-62 h-24 object-contain' />
                    </div>
                    <h1 className="text-3xl font-bold mb-4 text-white text-center">Kisan Satta Volunteer Application Form</h1>
